...
use function PHPTasks\FizzTask\displayNumbers;

class FizzTest extends \PHPUnit\Framework\TestCase
{
    public function testOnMediumDistance()
    {
        $expected = '11 Fizz 13 14 FizzBuzz 16 17 Fizz 19 Buzz';
        $this->assertEquals($expected, displayNumbers(11, 20));
    }

    public function testOnShortDistance()
    {
        $expected = 'FizzBuzz 1 2 Fizz';
        $this->assertEquals($expected, displayNumbers(0, 3));
    }

    public function testOnZeroDistance()
    {
        $expected = 'FizzBuzz';
        $this->assertEquals($expected, displayNumbers(0, 0));

    }

    public function testOnLongDistance()
    {
        ...
        $this->assertEquals($expected, displayNumbers(0, 100));
    }
}